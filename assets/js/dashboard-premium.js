(function () {
    ...
    function renderDeviceMeta(data) {
        ...
        metaEl.innerHTML =
            ...
            '<span class="dev-meta-item" id="dev-last-seen"><i class="fa fa-clock-o"></i> Visto por último ' + formatLastSeen(data.lastSeenMins) + '</span>' +
    ...
    function renderRiskCard(data) {
        ...
        el.innerHTML =
            ...
            '<span>Índice de Risco Comportamental</span>' +
            ...
            '<p class="risk-note">Modelo de IA v3.2 · Atualizado ao vivo a partir dos buffers de interceptação</p>';
    }
    ...
    function showAlertToast(text) {
        ...
        toast.innerHTML =
            ...
            '<div><strong>Alerta ao vivo</strong><p>' + text + '</p></div>';
    ...
    function initAlertToasts(data) {
        var alerts = [
            'Nova mensagem de WhatsApp interceptada no dispositivo alvo',
            'Mudança de localização GPS detectada — revise a linha do tempo',
            'Conexão em rede Wi-Fi suspeita registrada',
            'Atividade no direct do Instagram fora do horário habitual',
            'Chamada de voz gravada — 4m 12s de duração',
            'Palavra-chave sensível em SMS sinalizada pelo scanner de IA'
        ];
    ...
    function updateLastSeen(data) {
        ...
        setInterval(function () {
            ...
            if (el) {
                el.innerHTML = '<i class="fa fa-clock-o"></i> Visto por último ' + formatLastSeen(mins);
            }
        }, 60000);
    }
